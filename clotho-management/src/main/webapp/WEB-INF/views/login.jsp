...
<html lang="en" >
    ...
    <head>
        ...
        <link href="${ctx}/resources/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
        <link href="${ctx}/resources/admin/pages/css/login-soft.css" rel="stylesheet" type="text/css"/>
        ...
        <link id="style_color" href="${ctx}/resources/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="login">
        ...
        <div class="logo">
            <a href="/">
                <img src="${ctx}/resources/admin/layout/img/logo-big.png" alt=""/>
            </a>
        </div>
        <!-- END LOGO -->
        ...
        <script src="${ctx}/resources/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="${ctx}/resources/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
        ...
        <script src="${ctx}/resources/admin/pages/scripts/login-soft.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <script>
